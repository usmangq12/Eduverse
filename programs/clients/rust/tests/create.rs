...
use eduverse_programs_client::{accounts::Counter, instructions::CreateBuilder};
...
#[tokio::test]
async fn create() {
    let mut context = ProgramTest::new("eduverse_programs", eduverse_programs_client::ID, None)
        .start_with_context()
        .await;
